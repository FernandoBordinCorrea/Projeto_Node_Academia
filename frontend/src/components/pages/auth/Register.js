...
function Register(){
    ...
    function handleSubmit(e){
        e.preventDefault()
        console.log('Dados a serem enviados:', user);  // ← Adicione esta linha
        register(user);
    }
    ...
    return(
        <section className={styles.form_container}>
            ...
            <form onSubmit={handleSubmit}>
                ...
                <Input text="Confirmacao de senha" type="password" name="confirmpassword" placeholder="Confirme a sua senha" handleOnChange={handleChange}/>
                <input type="submit" value="Cadastrar"/>
            </form>
            <p>
                Ja tem conta? <Link to="/login">Clique aqui</Link> para fazer login.
            </p>
        </section>
    )
}
